                    ...
                    <div id="step-2">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <option value="">Pilih Pekerjaan</option><option value="10" id="occupation_10">Aparatur Sipil Negara</option><option value="11" id="occupation_11">BUMN/BUMD</option><option value="7" id="occupation_7">Dosen/Guru</option><option value="2" id="occupation_2">Ibu Rumah Tangga</option><option value="4" id="occupation_4">Pegawai Negeri</option><option value="8" id="occupation_8">Pegawai Swasta</option><option value="1" id="occupation_1">Pelajar/Mahasiswa</option><option value="6" id="occupation_6">Pensiunan</option><option value="5" id="occupation_5">TNI/POLRI</option><option value="3" id="occupation_3">Wiraswasta</option><option value="9" id="occupation_9">Lainnya</option></select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <option value="">Pilih Penghasilan Kotor</option><option value="1" id="gross_income_1">&lt; 10 juta / tahun</option><option value="2" id="gross_income_2">&gt; 10 – 50 juta / tahun</option><option value="3" id="gross_income_3">&gt; 50 – 100 juta / tahun</option><option value="4" id="gross_income_4">&gt; 100 – 500 juta / tahun</option><option value="5" id="gross_income_5">&gt; 500 juta – 1 milyar / tahun</option><option value="6" id="gross_income_6">&gt; 1 milyar / tahun</option></select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <option value="">Pilih Sumber Dana</option><option value="3" id="source_of_fund_3">Bunga Tabungan</option><option value="5" id="source_of_fund_5">Dana dari orang tua atau anak</option><option value="7" id="source_of_fund_7">Dana dari suami atau istri</option><option value="6" id="source_of_fund_6">Hibah</option><option value="2" id="source_of_fund_2">Keuntungan Bisnis</option><option value="9" id="source_of_fund_9">Keuntungan Investasi</option><option value="1" id="source_of_fund_1">Pendapatan</option><option value="8" id="source_of_fund_8">Undian</option><option value="4" id="source_of_fund_4">Warisan</option><option value="10" id="source_of_fund_10">Lainnya</option></select>
                            </div>
                        </div>
                        </br>
                    </div>
