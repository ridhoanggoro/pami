    ...
    <div class="container">
        ...
        <div id="smartwizard">
            <ul>
                ...
                <li><a href="#step-2">Step 2<br /><small>Alamat</small></a></li>
                <li><a href="#step-3">Step 3<br /><small>Data Rekening Bank </small></a></li>
                <li><a href="#step-4">Step 4<br /><small>Pernyataan Persetujuan</small></a></li>
            </ul>

            <div>
                <div id="step-1" class="">
                    <h3 class="border-bottom border-gray pb-2">Profil</h3>
                    <div class="row input-row">
                        <div class="col-sm-12">
                            <label class="input-label">Nomor E-KTP</label>
                            <input id="id_number" name="id_number" type="tel" maxlength="16" class=" mandatory form-control input-text" placeholder="Masukkan Nomor E-KTP kamu">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block"><i>pastikan ukuran foto tidak lebih dari 10MB</i></p>
                    </div>

                    <div class="row input-row hidden">
                        <div class="col-sm-12">
                    ...
                    <div class="row input-row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="row" id="dob-input">
                                <div class="col-xs-4">
                                    <select id="dob-date" class="form-control input-select input-dob-date">
                                        <option id="opt_00" value="" disabled="" selected="">DD</option>
                                        <option id="opt_1">01</option>
                                        <option id="opt_2">02</option>
                                        <option id="opt_3">03</option>
                                        <option id="opt_4">04</option>
                                        <option id="opt_5">05</option>
                                        <option id="opt_6">06</option>
                                        <option id="opt_7">07</option>
                                        <option id="opt_8">08</option>
                                        <option id="opt_9">09</option>
                                        <option id="opt_10">10</option>
                                        <option id="opt_11">11</option>
                                        <option id="opt_12">12</option>
                                        <option id="opt_13">13</option>
                                        <option id="opt_14">14</option>
                                        <option id="opt_15">15</option>
                                        <option id="opt_16">16</option>
                                        <option id="opt_17">17</option>
                                        <option id="opt_18">18</option>
                                        <option id="opt_19">19</option>
                                        <option id="opt_20">20</option>
                                        <option id="opt_21">21</option>
                                        <option id="opt_22">22</option>
                                        <option id="opt_23">23</option>
                                        <option id="opt_24">24</option>
                                        <option id="opt_25">25</option>
                                        <option id="opt_26">26</option>
                                        <option id="opt_27">27</option>
                                        <option id="opt_28">28</option>
                                        <option id="opt_29">29</option>
                                        <option id="opt_30">30</option>
                                        <option id="opt_31">31</option>
                                    </select>
                                </div>
                                <div class="col-xs-4 input-dob-month-div">
                                    <select class="form-control input-select" id="dob-month">
                                ...
                                <div class="col-xs-4">
                                    <input type="tel" class="form-control input-text input-dob-year" placeholder="YYYY" maxlength="4" id="dob-year">
                                </div>
                            </div>
                    ...
                    <div class="row input-row">
                        <div class="col-sm-12">
                            ...
                            <select id="religion" name="religion" class="mandatory form-control input-select">
                ...
                <div id="step-2" class="">
                    <h3 class="border-bottom border-gray pb-2">Alamat</h3>
                    <div class="row address-ktp-row">

                        <div class="col-sm-10 col-sm-offset-1 address-ktp-col">

                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <span class="sub-section-title">Alamat sesuai di E-KTP</span>
                                </div>
                            </div>

                            <div class="row kyc-input-row">
                                <div class="col-sm-12">
                                    <label class="kyc-input-label">Alamat di E-KTP</label>
                            ...
                            <div class="row kyc-input-row">
                                <div class="col-sm-8">
                                    <label class="kyc-input-label">Kota</label>
                                    <select id="ktp_city" name="ktp_city" class="form-control mandatory kyc-input-select">
                                ...
                                <div class="col-sm-4 kyc-code-col">
                                    <label class="kyc-input-label">Kode Pos</label>
                                    <input id="ktp_postal_code" maxlength="5" name="ktp_postal_code" type="tel" class="mandatory form-control kyc-input-text postal_code" value="" placeholder="Masukkan kode pos">
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <select id="bank_list" class="form-control select2" style="width: 100%;">
                        ...
                        <div class="row kyc-input-bank-row">
                            <div class="col-sm-12">
                                <label>Nomor Rekening</label>
                                <input type="tel" class="form-control kyc-input-text" id="account_number" maxlength="16" value="">
                        ...
                        <div class="row kyc-input-bank-row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control kyc-input-text" id="account_name" maxlength="16" readonly="" value="Ridho Anggoro Naibaho">
                ...
                <div id="step-4" class="">
                    <div class="modal-body">
                        <h3 class="border-bottom border-gray pb-2">Pernyataan Persetujuan</h3>
                        <div class="col-sm-12 terms-div-col">
                            ...
                            <div class="row terms-agree-row">
                                <div class="col-sm-12 terms-agree-col">
                                    <span class="terms-info"><b style="font-size:18px;color:#485198;font-weight:bold;">Dengan menandatangani ini, Saya menyatakan bahwa:</b><br>1. Mengisi data dengan benar dan lengkap.<br>2. Mengerti dan menyetujui <b><a href="https://www.tanamduit.com/individual/index/termcondition" target="_blank">Syarat &amp; Ketentuan</a></b> tanamduit. <br>3. Mengerti dan menyetujui <a href="https://www.tanamduit.com/individual/index/privacypolicy" target="_blank">Kebijakan Privasi</a> tanamduit.</span>
                                </div>
                            </div>

                            <div class="row terms-sign-row hidden">
                                <div class="col-sm-12">
                                    <div id="terms-check">
                                        <input type="checkbox" name="agree" value="yes" class="kyc-check" id="kyc-agree">
                                        <label for="kyc-agree" class="kyc-input-check-label">Saya setuju dengan Syarat &amp; Ketentuan PAMI.
                                            <!-- <a href="#"><b>Lihat Syarat & Ketentuan</b></a> dan  <a href="#"><b>Kebijakan Privasi</b></a> --></label>
                                    </div>
                                </div>
                            </div>

                            <div class="col-md-12 col-xs-12 text-center" id="sign-error" style="padding-top: 10px;">
                                <label class="kyc-input-label">
                                    <?php echo date('d-M-Y'); ?>
                                </label>
                                <div class="row mar-bt-20" style="padding-top: 20px;">
                                    <input type="text" id="signatureDone" hidden="">
                                    <div id="signature" class="text-center col-md-12 col-sm-12 col-xs-12" style="padding: 0px !important;">
                                        <div class="dz-default dz-message">
                                            <img id="signPrev" src="images/registration/signature.png" style="max-width: 200px; max-height: 200px;">
                                        </div>
                                        <div class="signature-instruction-label" id="signature-instruction-default">Buat tanda tangan kamu di sini</div>
                                    </div>
