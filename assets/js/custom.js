$(document).ready(function() {
  ...
  /* Open modal CRUD for product */
  $(".content-wrapper").on("click",".modalButtonProduct", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'product/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_product').find('.modal-body').html(data);
      $('#nameModal_product').modal('show'); 
    })
  });
